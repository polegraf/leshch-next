...
function productPreview(p){if(p.category==='Мерч')return `<div class="merch-preview ${p.art}" aria-hidden="true"><svg viewBox="0 0 200 150">${p.art.startsWith('shirt')?'<path class="garment" d="M65 20 35 35 15 67 47 83 57 65 57 135 143 135 143 65 153 83 185 67 165 35 135 20Q100 42 65 20Z"/>':'<path class="garment" d="M45 95Q40 28 105 25Q163 27 160 97Z"/><path class="garment" d="M45 95Q110 80 160 97L188 118Q103 141 30 114Z"/>'}<text x="100" y="82" text-anchor="middle">DJ</text></svg><small>DIGITAL JAZZ</small></div>`;if(p.category==='Тайлы')return `<div class="tile-preview plan-preview"><small>ТАЙЛ</small><strong>${p.label}</strong></div>`;return p.category==='Темы'?`<div class="theme-preview look-${p.art}" aria-hidden="true"><div class="preview-cover"></div><div class="preview-person"><span class="preview-avatar">DJ</span><span><b>Твой профиль</b><small>Музыка — это ты</small></span></div><div class="preview-tags"><i>Диджей</i><i>Продюсер</i></div><div class="preview-lines"><i></i><i></i></div></div>`:`<div class="tile-preview look-${p.art}" aria-hidden="true"><span class="tile-signal"><i></i><i></i><i></i><i></i><i></i></span><strong>${p.label}</strong><small>DIGITAL JAZZ</small></div>`;}
