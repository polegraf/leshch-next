...
.pm-t{display:grid;gap:2px;min-width:0}.pm-t b{font-size:16px;font-weight:500;color:#F7F6FA;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pm-t small{font-size:14px;color:#8E88A8;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
