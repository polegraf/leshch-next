...
(() => {
 ...
 const routes={profile:'profile/index.html',public:'public-profile/index.html',chat:'chat/index.html',tours:'tours/index.html',search:'index.html#search',discovery:'index.html#discovery',tournaments:'index.html#tournaments',shop:'index.html#shop',monitor:'index.html#monitor',afisha:'../dj-afisha/index.html'};
 ...
 document.addEventListener('click',e=>{
  ...
  const services={'туры':'tours','турниры':'tournaments','магазин':'shop','афиша':'afisha'};
